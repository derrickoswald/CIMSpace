...
(
    ...
    function (base)
    {
        ...
        function export_AccumulationKind (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_FlowDirectionKind (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_MeasuringPeriodKind (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_MeasurementKind (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_CommodityKind (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_AggregateKind (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_MacroPeriodKind (obj, exporters, full)
        {
            var fields = [];
        ...
        return (
            {
                ...
                export_AccumulationKind: export_AccumulationKind,
                export_AggregateKind: export_AggregateKind,
                parse_FlowDirectionKind: parse_FlowDirectionKind,
                parse_AggregateKind: parse_AggregateKind,
                export_MeasurementKind: export_MeasurementKind,
                export_CommodityKind: export_CommodityKind,
                export_MeasuringPeriodKind: export_MeasuringPeriodKind,
                export_MacroPeriodKind: export_MacroPeriodKind,
                parse_AccumulationKind: parse_AccumulationKind,
                parse_MeasurementKind: parse_MeasurementKind,
                export_FlowDirectionKind: export_FlowDirectionKind,
