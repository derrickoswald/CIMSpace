...
(
    ...
    function (base, Common, Core)
    {
        ...
        function export_MarketRole (obj, exporters, full)
        {
        ...
        function export_RegisteredResource (obj, exporters, full)
        {
        ...
        function export_MarketRoleKind (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_MarketParticipant (obj, exporters, full)
        {
        ...
        return (
            {
                ...
                export_MarketParticipant: export_MarketParticipant,
                parse_MarketRoleKind: parse_MarketRoleKind,
                parse_MarketParticipant: parse_MarketParticipant,
                export_MarketRoleKind: export_MarketRoleKind,
                export_RegisteredResource: export_RegisteredResource,
                parse_RegisteredResource: parse_RegisteredResource,
                export_MarketRole: export_MarketRole
            }
        );
    }
);