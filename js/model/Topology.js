...
(
    ...
    function (base, Core)
    {
        ...
        function export_BusNameMarker (obj, exporters, full)
        {
        ...
        function export_DCTopologicalNode (obj, exporters, full)
        {
            var fields = exporters["IdentifiedObject"](obj, exporters, false);
        ...
        function export_TopologicalNode (obj, exporters, full)
        {
            var fields = exporters["IdentifiedObject"](obj, exporters, false);
        ...
        function export_TopologicalIsland (obj, exporters, full)
        {
            var fields = exporters["IdentifiedObject"](obj, exporters, false);
        ...
        return (
            {
                ...
                export_TopologicalIsland: export_TopologicalIsland,
                export_DCTopologicalNode: export_DCTopologicalNode,
                export_BusNameMarker: export_BusNameMarker,
                export_TopologicalNode: export_TopologicalNode,
