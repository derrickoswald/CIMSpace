...
(
    ...
    function (base)
    {
        ...
        function export_EnergyProductType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_FlagTypeRMR (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_MarketType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_RampRateCondition (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_BidCalculationBasis (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_EnergyTransactionType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_ContractType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_BidType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_EquipmentStatusType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_MarketProductSelfSchedType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_MQSCHGType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_InterTieDirection (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_AutomaticDispatchMode (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_CommitmentType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_YesNo (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_ResourceAssnType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_AnalogLimitType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_MPMTestMethodType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_AutomaticDispInstTypeCommitment (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_PassIndicatorType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_ActionType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_ResultsConstraintType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_FlowDirectionType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_FuelSource (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_TimeOfUse (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_MPMTestOutcome (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_RampModeType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_MarketProductType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_MPMTestIdentifierType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_SelfSchedReferenceType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_LoadForecastType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_TradeType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_ExecutionType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_ResourceLimitIndicator (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_ParticipationCategoryMPM (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_MktBillMediaKind (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_BidMitigationStatus (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_SelfScheduleBreakdownType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_MktAccountKind (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_CRRCategoryType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_ResourceRegistrationStatus (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_OnOff (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_CRRRoleType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_AnodeType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_RampRateType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_EnergyPriceIndexType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_ApnodeType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_RampCurveType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_BidTypeRMR (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_DispatchResponseType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_MktInvoiceLineItemKind (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_ConstraintLimitType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_ResourceCapacityType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_SwitchStatusType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_TRType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_CRRHedgeType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_PurposeFlagType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_ConstraintRampType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_CRRSegmentType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_ResourceAncillaryServiceType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_BidMitigationType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_ReserveRequirementType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_MQSInstructionSource (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_AreaControlMode (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_CheckOutType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_UnitType (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_CostBasis (obj, exporters, full)
        {
            var fields = [];
        ...
        return (
            {
                export_TRType: export_TRType,
                export_BidTypeRMR: export_BidTypeRMR,
                parse_BidTypeRMR: parse_BidTypeRMR,
                export_EnergyProductType: export_EnergyProductType,
                export_ResourceAncillaryServiceType: export_ResourceAncillaryServiceType,
                export_MktInvoiceLineItemKind: export_MktInvoiceLineItemKind,
                parse_ContractType: parse_ContractType,
                parse_BidType: parse_BidType,
                export_DispatchResponseType: export_DispatchResponseType,
                ...
                export_RampCurveType: export_RampCurveType,
                export_MQSCHGType: export_MQSCHGType,
                export_YesNo: export_YesNo,
                parse_EquipmentStatusType: parse_EquipmentStatusType,
                parse_FlagTypeRMR: parse_FlagTypeRMR,
                export_ResourceLimitIndicator: export_ResourceLimitIndicator,
                ...
                export_CheckOutType: export_CheckOutType,
                export_ReserveRequirementType: export_ReserveRequirementType,
                export_MarketProductType: export_MarketProductType,
                ...
                export_TimeOfUse: export_TimeOfUse,
                export_ResourceRegistrationStatus: export_ResourceRegistrationStatus,
                parse_CRRRoleType: parse_CRRRoleType,
                export_CommitmentType: export_CommitmentType,
                ...
                export_PurposeFlagType: export_PurposeFlagType,
                ...
                export_RampRateType: export_RampRateType,
                export_MarketProductSelfSchedType: export_MarketProductSelfSchedType,
                export_EnergyTransactionType: export_EnergyTransactionType,
                parse_ParticipationCategoryMPM: parse_ParticipationCategoryMPM,
                export_ResultsConstraintType: export_ResultsConstraintType,
                parse_ConstraintRampType: parse_ConstraintRampType,
                export_MPMTestOutcome: export_MPMTestOutcome,
                ...
                export_CRRRoleType: export_CRRRoleType,
                export_LoadForecastType: export_LoadForecastType,
                export_MQSInstructionSource: export_MQSInstructionSource,
                parse_CRRCategoryType: parse_CRRCategoryType,
                parse_UnitType: parse_UnitType,
                parse_BidMitigationType: parse_BidMitigationType,
                export_ResourceCapacityType: export_ResourceCapacityType,
                parse_ConstraintLimitType: parse_ConstraintLimitType,
                export_MarketType: export_MarketType,
                export_MktAccountKind: export_MktAccountKind,
                parse_LoadForecastType: parse_LoadForecastType,
                parse_SelfSchedReferenceType: parse_SelfSchedReferenceType,
                export_CostBasis: export_CostBasis,
                ...
                export_MPMTestMethodType: export_MPMTestMethodType,
                ...
                export_SwitchStatusType: export_SwitchStatusType,
                parse_CRRSegmentType: parse_CRRSegmentType,
                parse_ExecutionType: parse_ExecutionType,
                export_FlagTypeRMR: export_FlagTypeRMR,
                export_TradeType: export_TradeType,
                export_RampRateCondition: export_RampRateCondition,
                export_AnodeType: export_AnodeType,
                export_ParticipationCategoryMPM: export_ParticipationCategoryMPM,
                export_BidCalculationBasis: export_BidCalculationBasis,
                export_ContractType: export_ContractType,
                export_UnitType: export_UnitType,
                parse_EnergyTransactionType: parse_EnergyTransactionType,
                parse_FuelSource: parse_FuelSource,
                export_PassIndicatorType: export_PassIndicatorType,
                parse_MarketType: parse_MarketType,
                parse_CheckOutType: parse_CheckOutType,
                export_BidType: export_BidType,
                parse_CRRHedgeType: parse_CRRHedgeType,
                parse_MktInvoiceLineItemKind: parse_MktInvoiceLineItemKind,
                export_AutomaticDispatchMode: export_AutomaticDispatchMode,
                export_AnalogLimitType: export_AnalogLimitType,
                export_EnergyPriceIndexType: export_EnergyPriceIndexType,
                export_SelfScheduleBreakdownType: export_SelfScheduleBreakdownType,
                export_InterTieDirection: export_InterTieDirection,
                export_ExecutionType: export_ExecutionType,
                export_RampModeType: export_RampModeType,
                export_SelfSchedReferenceType: export_SelfSchedReferenceType,
                parse_DispatchResponseType: parse_DispatchResponseType,
                export_OnOff: export_OnOff,
                export_AreaControlMode: export_AreaControlMode,
                parse_PassIndicatorType: parse_PassIndicatorType,
                export_AutomaticDispInstTypeCommitment: export_AutomaticDispInstTypeCommitment,
                parse_MktBillMediaKind: parse_MktBillMediaKind,
                parse_FlowDirectionType: parse_FlowDirectionType,
                export_BidMitigationType: export_BidMitigationType,
                parse_AutomaticDispatchMode: parse_AutomaticDispatchMode,
                export_CRRCategoryType: export_CRRCategoryType,
                export_BidMitigationStatus: export_BidMitigationStatus,
                export_ActionType: export_ActionType,
                export_EquipmentStatusType: export_EquipmentStatusType,
                export_FuelSource: export_FuelSource,
                parse_InterTieDirection: parse_InterTieDirection,
                export_MktBillMediaKind: export_MktBillMediaKind,
                export_ApnodeType: export_ApnodeType,
                parse_ResourceRegistrationStatus: parse_ResourceRegistrationStatus,
                export_ConstraintLimitType: export_ConstraintLimitType,
                parse_TradeType: parse_TradeType,
                parse_RampCurveType: parse_RampCurveType,
                parse_CostBasis: parse_CostBasis,
                export_MPMTestIdentifierType: export_MPMTestIdentifierType,
                parse_ResultsConstraintType: parse_ResultsConstraintType,
                export_ResourceAssnType: export_ResourceAssnType,
                export_CRRSegmentType: export_CRRSegmentType,
                export_FlowDirectionType: export_FlowDirectionType,
                export_CRRHedgeType: export_CRRHedgeType,
                export_ConstraintRampType: export_ConstraintRampType
            }
        );
    }
);