...
(
    ...
    function (base, Assets)
    {
        ...
        function export_MaintenanceDataSet (obj, exporters, full)
        {
        ...
        function export_InspectionDataSet (obj, exporters, full)
        {
            var fields = exporters["ProcedureDataSet"](obj, exporters, false);
        ...
        function export_DiagnosisDataSet (obj, exporters, full)
        {
            var fields = exporters["ProcedureDataSet"](obj, exporters, false);
        ...
        function export_TestDataSet (obj, exporters, full)
        {
            var fields = exporters["ProcedureDataSet"](obj, exporters, false);
        ...
        return (
            {
                ...
                export_DiagnosisDataSet: export_DiagnosisDataSet,
                export_TestDataSet: export_TestDataSet,
                parse_DiagnosisDataSet: parse_DiagnosisDataSet,
                parse_TestDataSet: parse_TestDataSet,
                export_MaintenanceDataSet: export_MaintenanceDataSet,
                export_InspectionDataSet: export_InspectionDataSet,
