...
(
    ...
    function (base, Core, InfAssets)
    {
        ...
        function export_GeneratorTypeAsset (obj, exporters, full)
        {
        ...
        function export_TypeAssetCatalogue (obj, exporters, full)
        {
        ...
        return (
            {
                ...
                export_GeneratorTypeAsset: export_GeneratorTypeAsset,
                export_TypeAssetCatalogue: export_TypeAssetCatalogue
            }
        );
    }
);