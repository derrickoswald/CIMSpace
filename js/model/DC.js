...
(
    ...
    function (base, Core, Wires)
    {
        ...
        function export_DCNode (obj, exporters, full)
        {
        ...
        function export_DCTopologicalIsland (obj, exporters, full)
        {
            var fields = exporters["IdentifiedObject"](obj, exporters, false);
        ...
        function export_CsPpccControlKind (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_VsConverter (obj, exporters, full)
        {
        ...
        function export_DCConverterOperatingModeKind (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_DCDisconnector (obj, exporters, full)
        {
        ...
        function export_VsQpccControlKind (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_DCSeriesDevice (obj, exporters, full)
        {
        ...
        function export_DCBaseTerminal (obj, exporters, full)
        {
        ...
        function export_DCBusbar (obj, exporters, full)
        {
            var fields = exporters["DCConductingEquipment"](obj, exporters, false);
        ...
        function export_ACDCConverter (obj, exporters, full)
        {
        ...
        function export_DCShunt (obj, exporters, full)
        {
            var fields = exporters["DCConductingEquipment"](obj, exporters, false);
        ...
        function export_DCLineSegment (obj, exporters, full)
        {
            var fields = exporters["DCConductingEquipment"](obj, exporters, false);
        ...
        function export_PerLengthDCLineParameter (obj, exporters, full)
        {
        ...
        function export_VsPpccControlKind (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_DCGround (obj, exporters, full)
        {
            var fields = exporters["DCConductingEquipment"](obj, exporters, false);
        ...
        function export_DCEquipmentContainer (obj, exporters, full)
        {
        ...
        function export_VsCapabilityCurve (obj, exporters, full)
        {
        ...
        function export_DCLine (obj, exporters, full)
        {
        ...
        function export_CsOperatingModeKind (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_ACDCConverterDCTerminal (obj, exporters, full)
        {
        ...
        function export_DCBreaker (obj, exporters, full)
        {
            var fields = exporters["DCSwitch"](obj, exporters, false);
        ...
        function export_DCChopper (obj, exporters, full)
        {
            var fields = exporters["DCConductingEquipment"](obj, exporters, false);
        ...
        function export_DCPolarityKind (obj, exporters, full)
        {
            var fields = [];
        ...
        function export_DCConverterUnit (obj, exporters, full)
        {
            var fields = exporters["DCEquipmentContainer"](obj, exporters, false);
        ...
        function export_CsConverter (obj, exporters, full)
        {
            var fields = exporters["ACDCConverter"](obj, exporters, false);
        ...
        function export_DCTerminal (obj, exporters, full)
        {
            var fields = exporters["DCBaseTerminal"](obj, exporters, false);
        ...
        function export_DCConductingEquipment (obj, exporters, full)
        {
        ...
        function export_DCSwitch (obj, exporters, full)
        {
            var fields = exporters["DCConductingEquipment"](obj, exporters, false);
        ...
        return (
            {
                export_DCNode: export_DCNode,
                export_DCBusbar: export_DCBusbar,
                export_CsOperatingModeKind: export_CsOperatingModeKind,
                parse_DCTopologicalIsland: parse_DCTopologicalIsland,
                export_ACDCConverterDCTerminal: export_ACDCConverterDCTerminal,
                parse_DCConverterOperatingModeKind: parse_DCConverterOperatingModeKind,
                export_DCConverterUnit: export_DCConverterUnit,
                parse_DCTerminal: parse_DCTerminal,
                parse_CsOperatingModeKind: parse_CsOperatingModeKind,
                export_DCEquipmentContainer: export_DCEquipmentContainer,
                parse_VsQpccControlKind: parse_VsQpccControlKind,
                export_VsCapabilityCurve: export_VsCapabilityCurve,
                parse_VsConverter: parse_VsConverter,
                export_DCGround: export_DCGround,
                export_DCPolarityKind: export_DCPolarityKind,
                parse_DCShunt: parse_DCShunt,
                parse_DCLine: parse_DCLine,
                export_PerLengthDCLineParameter: export_PerLengthDCLineParameter,
                export_DCConverterOperatingModeKind: export_DCConverterOperatingModeKind,
                export_CsConverter: export_CsConverter,
                parse_DCLineSegment: parse_DCLineSegment,
                export_DCSeriesDevice: export_DCSeriesDevice,
                parse_DCBreaker: parse_DCBreaker,
                parse_CsConverter: parse_CsConverter,
                parse_VsCapabilityCurve: parse_VsCapabilityCurve,
                export_DCSwitch: export_DCSwitch,
                parse_ACDCConverterDCTerminal: parse_ACDCConverterDCTerminal,
                parse_DCEquipmentContainer: parse_DCEquipmentContainer,
                export_VsQpccControlKind: export_VsQpccControlKind,
                parse_DCDisconnector: parse_DCDisconnector,
                export_ACDCConverter: export_ACDCConverter,
                export_CsPpccControlKind: export_CsPpccControlKind,
                export_DCShunt: export_DCShunt,
                export_DCDisconnector: export_DCDisconnector,
                export_DCLine: export_DCLine,
                parse_DCChopper: parse_DCChopper,
                export_VsConverter: export_VsConverter,
                parse_DCNode: parse_DCNode,
                parse_VsPpccControlKind: parse_VsPpccControlKind,
                export_DCBaseTerminal: export_DCBaseTerminal,
                export_DCTopologicalIsland: export_DCTopologicalIsland,
                parse_DCBaseTerminal: parse_DCBaseTerminal,
                parse_DCBusbar: parse_DCBusbar,
                parse_DCConverterUnit: parse_DCConverterUnit,
                export_DCChopper: export_DCChopper,
                export_VsPpccControlKind: export_VsPpccControlKind,
                ...
                export_DCBreaker: export_DCBreaker,
                export_DCConductingEquipment: export_DCConductingEquipment,
                parse_DCGround: parse_DCGround,
                export_DCTerminal: export_DCTerminal,
                export_DCLineSegment: export_DCLineSegment,
